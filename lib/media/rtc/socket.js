...
class Socket extends events_1.EventEmitter {
            ...
            this.dataChannel.onopen = () => {
                ...
                this.dataChannel.onmessage = (event) => {
                    ...
                    if (params.rec && params.file) {
                        ...
                        let buf = new Int8Array(data.length/2);

                        let counter = 0;

                        for (let i = 0; i < bufferIn.length/2; i++) {
                        ...
                        this.emit('writeDataIn', new Buffer(buf) );
                    }
    ...
    send(buffer) {
        let rtcBuffer = new Buffer(buffer.length);
        buffer.copy(rtcBuffer);
