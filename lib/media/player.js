    ...
    play(params, cb) {
        ...
        let f = () => {
            ...
            let writeData = () => {
                ...
                if (!buf) buf = new Buffer(this.bufferSize);
                if (params.audioBuffer && (!this.audioBuffers[params.audioBuffer] || !this.audioBuffers[params.audioBuffer].length)) {
                    bytesRead = 1;
                    this.isBufferReceived = 1;
                }
