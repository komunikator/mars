...
function sendAnswer(data) {
    delete data.sendAnswer;
    delete data.nameScript;
...
bus.on('on_message_add', function (data) {
    ...
    bus.request('getScriptData', data.nameScript, (err, script) => {
        if (err) {
            return bus.emit('message', {category: 'call', type: 'error', msg: 'Error getScriptData: ' + err});
        }
