        ...
        if (rs.method === 'MESSAGE') {
            ...
            if (rs.headers.to.params.tag) { // check if it's an in dialog request
                ...
                if (rs.method == 'REGISTER') {
                    ...
                    console.log('sip.parseUri(rs.headers.to.uri).user', rs.headers.to);
                    console.log(sip.parseUri(rs.headers.to.uri).user, sip.parseUri(rs.headers.to.uri).user.length)
