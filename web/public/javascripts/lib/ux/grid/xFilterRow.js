...
Ext.define('Ext.ux.grid.xFilterRow', {
	...
	storeSearch: function() {		
		...
		if(me.remoteFilter) {
			...
			me.grid.store.proxy.extraParams.search = Ext.JSON.encode(me.getSearchValues());
			//console.log(me.grid.store.proxy.extraParams.search);	
