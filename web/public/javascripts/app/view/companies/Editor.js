...
Ext.define('IVR.view.companies.Editor', {
    extend: 'Ext.container.Container',
    xtype: 'companiesEditor',
    ...
    items: [
        {
            ...
            elementName: lang.company_,
            store: Ext.data.StoreManager.lookup('CompaniesList') ? Ext.data.StoreManager.lookup('CompaniesList') : Ext.create('IVR.store.CompaniesList')
        },
        {
            region: 'center',
            frame: true,
